module.exports = {
  ...
  Lavalink: {
    ...
    pass: process.env.LAVALINK_PASSWORD ?? "", //- The password of the lavalink server.
    secure: process.env.LAVALINK_SECURE ?? false, // Set this to true if the lavalink uses SSL. if not set it to false.
